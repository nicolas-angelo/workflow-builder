...
export function ChatInput({
  ...
  return (
    ...
    >
      <InputGroup
        className={cn(
          'rounded-2xl focus-within:ring-1 focus-within:ring-ring',
          className
        )}
        {...props}
      >
...
export type ChatInputMentionProps<
...
export function ChatInputMention<
  T extends BaseMentionItem = BaseMentionItem,
>({
  type,
  trigger,
...
export type ChatInputGroupButtonProps = ComponentProps<
  typeof InputGroupButton
>
...
export function parseContent<
  Configs extends readonly MentionConfig<any>[],
>(json: JSONContent, configs: Configs): ParsedChatInputValue<Configs> {
  let content = ''
